...
#define PACMAN_SETTING_LIST(X)                                                                     \
    ...
    X(GAME,                  "game",                  ENUM,   0,     PACMAN_GAME_TEMPEST,       game_labels,       apply_game,                  true,  false, CONFIG_PACMAN_DEFAULT_GAME)   \
    ...
    X(GAME_FLOOR,              "game-floor",            COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_FLOOR_COLOR)   \
    X(GAME_SOLID,              "game-solid",            COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_SOLID_COLOR)   \
    X(GAME_BRICK,              "game-brick",            COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_BRICK_COLOR)   \
    X(GAME_BRICK_EDGE,         "game-brick-edge",       COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_BRICK_EDGE_COLOR)   \
    X(GAME_BOMB,               "game-bomb",             COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_BOMB_COLOR)   \
    X(GAME_FLAME,              "game-flame",            COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_FLAME_COLOR)   \
    X(GAME_FLAME_HOT,          "game-flame-hot",        COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_FLAME_HOT_COLOR)   \
    X(GAME_BOMBER,             "game-bomber",           COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_BOMBER_COLOR)   \
    X(GAME_BOMBER_TRIM,        "game-bomber-trim",      COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_BOMBER_TRIM_COLOR)   \
    X(GAME_FOE,                "game-foe",              COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_FOE_COLOR)   \
    X(GAME_FOE_EYE,            "game-foe-eye",          COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_FOE_EYE_COLOR)   \
    X(GAME_PICKUP,             "game-pickup",           COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_PICKUP_COLOR)   \
    X(GAME_EXIT,               "game-exit",             COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_EXIT_COLOR)   \
    X(GAME_RING,               "game-ring",             COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_RING_COLOR)   \
    X(GAME_RING_CROWD,         "game-ring-crowd",       COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_RING_CROWD_COLOR)   \
    X(GAME_RING_FLOOR,         "game-ring-floor",       COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_RING_FLOOR_COLOR)   \
    X(GAME_FIGHTER_0,          "game-fighter-0",        COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_FIGHTER_0_COLOR)   \
    X(GAME_FIGHTER_0_TRIM,     "game-fighter-0-trim",   COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_FIGHTER_0_TRIM_COLOR)   \
    X(GAME_FIGHTER_1,          "game-fighter-1",        COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_FIGHTER_1_COLOR)   \
    X(GAME_FIGHTER_1_TRIM,     "game-fighter-1-trim",   COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_FIGHTER_1_TRIM_COLOR)   \
    X(GAME_SPARK,              "game-spark",            COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_SPARK_COLOR)   \
    X(GAME_FIREBALL,           "game-fireball",         COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_FIREBALL_COLOR)   \
    X(GAME_HEALTH,             "game-health",           COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_HEALTH_COLOR)   \
    X(GAME_HEALTH_LOST,        "game-health-lost",      COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_HEALTH_LOST_COLOR)   \
    X(GAME_SKY,                "game-sky",              COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_SKY_COLOR)   \
    X(GAME_HILL,               "game-hill",             COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_HILL_COLOR)   \
    X(GAME_GROUND,             "game-ground",           COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_GROUND_COLOR)   \
    X(GAME_GROUND_EDGE,        "game-ground-edge",      COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_GROUND_EDGE_COLOR)   \
    X(GAME_HERO,               "game-hero",             COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_HERO_COLOR)   \
    X(GAME_HERO_TRIM,          "game-hero-trim",        COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_HERO_TRIM_COLOR)   \
    X(GAME_GRUNT,              "game-grunt",            COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_GRUNT_COLOR)   \
    X(GAME_GRUNT_TRIM,         "game-grunt-trim",       COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_GRUNT_TRIM_COLOR)   \
    X(GAME_SHOT,               "game-shot",             COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_SHOT_COLOR)   \
    X(GAME_GRENADE,            "game-grenade",          COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_GRENADE_COLOR)   \
    X(GAME_BOOM,               "game-boom",             COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_BOOM_COLOR)   \
    X(GAME_CRATE,              "game-crate",            COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_CRATE_COLOR)   \
    ...
    X(GAME_SITE,               "game-site",             COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_SITE_COLOR)   \
    X(GAME_GIRDER,             "game-girder",           COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_GIRDER_COLOR)   \
    X(GAME_LADDER,             "game-ladder",           COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_LADDER_COLOR)   \
    X(GAME_CLIMBER,            "game-climber",          COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_CLIMBER_COLOR)   \
    X(GAME_CLIMBER_TRIM,       "game-climber-trim",     COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_CLIMBER_TRIM_COLOR)   \
    X(GAME_BARREL,             "game-barrel",           COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_BARREL_COLOR)   \
    X(GAME_APE,                "game-ape",              COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_APE_COLOR)   \
    X(GAME_APE_TRIM,           "game-ape-trim",         COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_APE_TRIM_COLOR)   \
    X(GAME_LADY,               "game-lady",             COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_LADY_COLOR)   \
    X(GAME_HAMMER,             "game-hammer",           COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_HAMMER_COLOR)   \
    X(GAME_DRUM,               "game-drum",             COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_DRUM_COLOR)   \
    X(GAME_VOID,               "game-void",             COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_VOID_COLOR)   \
    X(GAME_WELL,               "game-well",             COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_WELL_COLOR)   \
    X(GAME_RIM,                "game-rim",              COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_RIM_COLOR)   \
    X(GAME_CLAW,               "game-claw",             COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_CLAW_COLOR)   \
    X(GAME_CLAW_SHOT,          "game-claw-shot",        COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_CLAW_SHOT_COLOR)   \
    X(GAME_FLIPPER,            "game-flipper",          COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_FLIPPER_COLOR)   \
    X(GAME_TANKER,             "game-tanker",           COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_TANKER_COLOR)   \
    X(GAME_SPIKER,             "game-spiker",           COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_SPIKER_COLOR)   \
    X(GAME_PULSAR,             "game-pulsar",           COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_PULSAR_COLOR)   \
    X(GAME_SPIKE,              "game-spike",            COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_SPIKE_COLOR)   \
    X(GAME_BOLT,               "game-bolt",             COLOR,  0,     0xffffff,                NULL,              apply_game_palette,          true,  false,  CONFIG_PACMAN_BOLT_COLOR)   \
