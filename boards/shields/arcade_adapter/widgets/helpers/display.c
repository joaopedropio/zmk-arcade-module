...
void set_complete_colors_theme() {
    uint32_t splash_multicolor_0 = hex_string_to_uint(CONFIG_ARCADE_SPLASH_MULTICOLOR_0);
    uint32_t splash_multicolor_1 = hex_string_to_uint(CONFIG_ARCADE_SPLASH_MULTICOLOR_1);
    uint32_t splash_multicolor_2 = hex_string_to_uint(CONFIG_ARCADE_SPLASH_MULTICOLOR_2);
    uint32_t splash_multicolor_3 = hex_string_to_uint(CONFIG_ARCADE_SPLASH_MULTICOLOR_3);
    uint32_t splash_logo_color = hex_string_to_uint(CONFIG_ARCADE_SPLASH_LOGO_COLOR);
    uint32_t splash_created_by_color = hex_string_to_uint(CONFIG_ARCADE_SPLASH_CREATED_BY_COLOR);
    uint32_t splash_bg_color = hex_string_to_uint(CONFIG_ARCADE_SPLASH_BG_COLOR);
    uint32_t battery_widget_num_color = hex_string_to_uint(CONFIG_ARCADE_BATTERY_WIDGET_NUM_COLOR);
    uint32_t battery_widget_percentage_color = hex_string_to_uint(CONFIG_ARCADE_BATTERY_WIDGET_PERCENTAGE_COLOR);
    uint32_t battery_widget_text_color = hex_string_to_uint(CONFIG_ARCADE_BATTERY_WIDGET_TEXT_COLOR);
    uint32_t battery_widget_bg_color = hex_string_to_uint(CONFIG_ARCADE_BATTERY_WIDGET_BG_COLOR);
    uint32_t battery_num_color = hex_string_to_uint(CONFIG_ARCADE_BATTERY_NUM_COLOR);
    uint32_t battery_percentage_color = hex_string_to_uint(CONFIG_ARCADE_BATTERY_PERCENTAGE_COLOR);
    uint32_t battery_bg_color = hex_string_to_uint(CONFIG_ARCADE_BATTERY_BG_COLOR);
    uint32_t battery_num_color_1 = hex_string_to_uint(CONFIG_ARCADE_BATTERY_NUM_COLOR_1);
    uint32_t battery_percentage_color_1 = hex_string_to_uint(CONFIG_ARCADE_BATTERY_PERCENTAGE_COLOR_1);
    uint32_t battery_bg_color_1 = hex_string_to_uint(CONFIG_ARCADE_BATTERY_BG_COLOR_1);
    uint32_t battery_num_color_2 = hex_string_to_uint(CONFIG_ARCADE_BATTERY_NUM_COLOR_2);
    uint32_t battery_percentage_color_2 = hex_string_to_uint(CONFIG_ARCADE_BATTERY_PERCENTAGE_COLOR_2);
    uint32_t battery_bg_color_2 = hex_string_to_uint(CONFIG_ARCADE_BATTERY_BG_COLOR_2);
    uint32_t symbol_selected_color = hex_string_to_uint(CONFIG_ARCADE_SYMBOL_SELECTED_COLOR);
    uint32_t symbol_unselected_color = hex_string_to_uint(CONFIG_ARCADE_SYMBOL_UNSELECTED_COLOR);
    uint32_t symbol_bg_color = hex_string_to_uint(CONFIG_ARCADE_SYMBOL_BG_COLOR);
    uint32_t modifier_selected_color = hex_string_to_uint(CONFIG_ARCADE_MODIFIER_SELECTED_COLOR);
    uint32_t modifier_unselected_color = hex_string_to_uint(CONFIG_ARCADE_MODIFIER_UNSELECTED_COLOR);
    uint32_t modifier_bg_color = hex_string_to_uint(CONFIG_ARCADE_MODIFIER_BG_COLOR);
    uint32_t bt_num_color = hex_string_to_uint(CONFIG_ARCADE_BT_NUM_COLOR);
    uint32_t bt_bg_color = hex_string_to_uint(CONFIG_ARCADE_BT_BG_COLOR);
    uint32_t bt_status_ok_color = hex_string_to_uint(CONFIG_ARCADE_BT_STATUS_OK_COLOR);
    uint32_t bt_status_not_ok_color = hex_string_to_uint(CONFIG_ARCADE_BT_STATUS_NOT_OK_COLOR);
    uint32_t bt_status_open_color = hex_string_to_uint(CONFIG_ARCADE_BT_STATUS_OPEN_COLOR);
    uint32_t bt_status_bg_color = hex_string_to_uint(CONFIG_ARCADE_BT_STATUS_BG_COLOR);
    uint32_t theme_font_color = hex_string_to_uint(CONFIG_ARCADE_THEME_FONT_COLOR);
    uint32_t theme_font_color_1 = hex_string_to_uint(CONFIG_ARCADE_THEME_FONT_COLOR_1);
    uint32_t theme_font_bg_color = hex_string_to_uint(CONFIG_ARCADE_THEME_FONT_BG_COLOR);
    uint32_t layer_font_color = hex_string_to_uint(CONFIG_ARCADE_LAYER_FONT_COLOR);
    uint32_t layer_font_bg_color = hex_string_to_uint(CONFIG_ARCADE_LAYER_FONT_BG_COLOR);
    uint32_t logo_font_color = hex_string_to_uint(CONFIG_ARCADE_LOGO_FONT_COLOR);
    uint32_t logo_accent_color = hex_string_to_uint(CONFIG_ARCADE_LOGO_ACCENT_COLOR);
    uint32_t logo_bg_color = hex_string_to_uint(CONFIG_ARCADE_LOGO_BG_COLOR);
    uint32_t frame_color = hex_string_to_uint(CONFIG_ARCADE_FRAME_COLOR);
    uint32_t frame_color_1 = hex_string_to_uint(CONFIG_ARCADE_FRAME_COLOR_1);
    uint32_t menu_bg_color = hex_string_to_uint(CONFIG_ARCADE_MENU_BG_COLOR);
    uint32_t wpm_font_color = hex_string_to_uint(CONFIG_ARCADE_WPM_FONT_COLOR);
    uint32_t wpm_font_1_color = hex_string_to_uint(CONFIG_ARCADE_WPM_FONT_1_COLOR);
    uint32_t wpm_font_bg_color = hex_string_to_uint(CONFIG_ARCADE_WPM_FONT_BG_COLOR);
...
void apply_current_theme(uint8_t current_theme) {
    #ifdef CONFIG_ARCADE_USE_COMPLETE_CUSTOM_THEME
    if (current_theme == 0) {
