/*
 * Arcade dongle - game core (portable, no Zephyr/LVGL dependencies).
 *
 ...
 */
#define PM_MARGIN     ((ARC_PANEL - PM_WIDTH) / 2)            /* 12 at 9x24 */
#define PM_MARGIN_END (ARC_PANEL - PM_MARGIN - PM_WIDTH)      /* 12 at 9x24 */
